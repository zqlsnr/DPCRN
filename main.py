...
class Trainer():
    ...
    def __init__(self, args):
        ...
        if self.config_dict['name'] == 'DPCRN-base':
            self.dpcrn_model = DPCRN_model(batch_size=self.batch_size, length_in_s=self.second, lr=self.lr,
...
if __name__ == '__main__':
    ...
    parser.add_argument("--cuda", type=int, default=1, help='which GPU to use')
    parser.add_argument("--mode", type=str, default='train', help='train or test')
    parser.add_argument("--bs", type=int, default=16, help='batch size')
    parser.add_argument("--lr", type=float, default=1e-3, help='learning rate')
    parser.add_argument("--experiment_name", type=str, default='experiment_3', help='the experiment name')
    parser.add_argument("--second", type=int, default=8, help='length in second of every sample')
    parser.add_argument("--ckpt", type=str,
                        default='./models_experiment_1/experiment_1model_45_0.027834.h5',
                        help='the location of the weights')
